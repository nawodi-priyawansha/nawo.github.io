...
export const Timeline = ({ data, className }) => {
  ...
  return (
    <div
      className={cn(
        "w-full bg-secondary border-border md:px-10 pt-0 md:pt-10 rounded-2xl overflow-visible mt-8 mb-8",
        className
      )}
      ref={containerRef}
    >
      ...
      <div ref={ref} className={cn("relative max-w-7xl mx-auto pb-20")}>
          ...
          >
            ...
            >
              ...
              >
                <div
                  className={cn(
                    "h-3 w-3 rounded-full bg-secondary-content dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 p-1 md:p-2"
                  )}
                />
              </div>
              <h3
                className={cn(
                  "hidden md:block text-xl md:pl-20 md:text-3xl font-bold text-secondary-content"
                )}
              >
                {item.title}
              </h3>
            ...
            <div className={cn("relative pl-20 pr-4 md:pl-4 w-full")}>
              <div
                className={cn(
                  "md:hidden block text-base mb-4 text-left font-bold text-secondary-content"
                )}
              >
                {item.title}
              </div>
        ...
        <div
          ...
          className={cn(
            "absolute md:left-8 left-8 top-0 overflow-hidden w-[2px] bg-gradient-to-b from-primary-content to-primary-content [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)]"
          )}
        >
          <motion.div
            style={{
            ...
            className={cn(
              "absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-[var(--gradient-start)] via-[var(--gradient-mid)] to-[var(--gradient-end)] from-[0%] via-[10%] to-[100%] rounded-full"
            )}
          />
        </div>
      </div>
