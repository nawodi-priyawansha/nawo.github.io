const Logo = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      ...
      {/* Letter "N" - Mirrored */}
      <path
        d="M26.5 8L23.5 8L23.5 16.5L19 8L16 8L16 22L19 22L19 13.5L23.5 22L26.5 22L26.5 8Z"
        fill="url(#paint4_linear_251_2154)"
      />
      <defs>
        <linearGradient
        ...
        {/* Gradient for the mirrored letter "N" */}
        <linearGradient
          id="paint4_linear_251_2154"
          x1="26.5"
          y1="15"
          x2="16"
          y2="15"
