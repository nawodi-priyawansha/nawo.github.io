...
const Navbar = () => {
  ...
  return (
    <nav className="bg-primary border-border h-16 overflow-hidden border-b fixed top-0 left-0 w-full z-50 shadow-md">
      <div className="mx-auto flex h-full w-dvw max-w-[1300px] items-center justify-between px-4 py-1">
        {isVisible ? (
          ...
          <Link href="/">
            <div className="animate-fade-up text-primary-content relative flex items-center gap-3 transition-all duration-300 md:static">
              <Logo />
              <span className="text-primary-content">Nawodi_Priyawansha</span>
            </div>
          </Link>
        )}
